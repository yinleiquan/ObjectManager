...
public class OkHttp3Util {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(AppContext.getInstance().getCacheDir().getAbsolutePath(), "MyCache");
    ...
    private static class MyIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isConnected(AppContext.getInstance())) {
                ToastUtil.showShort(AppContext.getInstance(), "未连接网络");
            ...
            if (NetUtil.isConnected(AppContext.getInstance().getApplicationContext())) {
